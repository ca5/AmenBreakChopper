...
AmenBreakControllerAudioProcessorEditor::
  ...
  mSequencePositionLabel.setText("Sequence Position",
                                 juce::dontSendNotification);
  addAndMakeVisible(mSequencePositionLabel);
  mNoteSequencePositionLabel.setText("Note Sequence Position",
                                     juce::dontSendNotification);
  addAndMakeVisible(mNoteSequencePositionLabel);

  mSequencePositionSlider.setSliderStyle(
      juce::Slider::SliderStyle::LinearHorizontal);
  mSequencePositionSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, true, 100,
                                          25);
  mSequencePositionSlider.setInterceptsMouseClicks(false, false);
  addAndMakeVisible(mSequencePositionSlider);

  mNoteSequencePositionSlider.setSliderStyle(
      juce::Slider::SliderStyle::LinearHorizontal);
  mNoteSequencePositionSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, true,
                                              100, 25);
  ...
  mMidiOutputChannelLabel.setText("MIDI Out Channel",
                                  juce::dontSendNotification);
  addAndMakeVisible(mMidiOutputChannelLabel);

  mMidiInputChannelSlider.setSliderStyle(
      juce::Slider::SliderStyle::IncDecButtons);
  mMidiInputChannelSlider.setTextBoxStyle(juce::Slider::TextBoxLeft, true, 50,
                                          25);
  addAndMakeVisible(mMidiInputChannelSlider);
  mMidiOutputChannelSlider.setSliderStyle(
      juce::Slider::SliderStyle::IncDecButtons);
  mMidiOutputChannelSlider.setTextBoxStyle(juce::Slider::TextBoxLeft, true, 50,
                                           25);
  ...
  mMidiCcHardResetLabel.setText("Hard Reset CC", juce::dontSendNotification);
  addAndMakeVisible(mMidiCcHardResetLabel);
  mMidiCcSoftResetLabel.setText("Soft Reset CC", juce::dontSendNotification);
  addAndMakeVisible(mMidiCcSoftResetLabel);

  mMidiCcSeqResetSlider.setSliderStyle(
      juce::Slider::SliderStyle::IncDecButtons);
  mMidiCcSeqResetSlider.setTextBoxStyle(juce::Slider::TextBoxLeft, true, 50,
                                        25);
  addAndMakeVisible(mMidiCcSeqResetSlider);
  addAndMakeVisible(mMidiCcSeqResetModeComboBox);

  mMidiCcHardResetSlider.setSliderStyle(
      juce::Slider::SliderStyle::IncDecButtons);
  mMidiCcHardResetSlider.setTextBoxStyle(juce::Slider::TextBoxLeft, true, 50,
                                         25);
  addAndMakeVisible(mMidiCcHardResetSlider);
  addAndMakeVisible(mMidiCcHardResetModeComboBox);

  mMidiCcSoftResetSlider.setSliderStyle(
      juce::Slider::SliderStyle::IncDecButtons);
  mMidiCcSoftResetSlider.setTextBoxStyle(juce::Slider::TextBoxLeft, true, 50,
                                         25);
  ...
  mOscHostAddressEditor.setText(audioProcessor.getValueTreeState()
                                    .state.getProperty("oscHostAddress")
                                    .toString());
  ...
  mOscReceivePortSlider.setSliderStyle(
      juce::Slider::SliderStyle::IncDecButtons);
  mOscReceivePortSlider.setTextBoxStyle(juce::Slider::TextBoxLeft, true, 70,
                                        25);
  ...
  mHardResetButton.setButtonText("Hard Reset");
  mHardResetButton.addListener(this);
  addAndMakeVisible(mHardResetButton);
  ...
  // === Attachments ===
  mSequencePositionAttachment.reset(
      new juce::AudioProcessorValueTreeState::SliderAttachment(
          audioProcessor.getValueTreeState(), "sequencePosition",
          mSequencePositionSlider));
  mNoteSequencePositionAttachment.reset(
      new juce::AudioProcessorValueTreeState::SliderAttachment(
          audioProcessor.getValueTreeState(), "noteSequencePosition",
          mNoteSequencePositionSlider));
  mMidiInputChannelAttachment.reset(
      new juce::AudioProcessorValueTreeState::SliderAttachment(
          audioProcessor.getValueTreeState(), "midiInputChannel",
          mMidiInputChannelSlider));
  mMidiOutputChannelAttachment.reset(
      new juce::AudioProcessorValueTreeState::SliderAttachment(
          audioProcessor.getValueTreeState(), "midiOutputChannel",
          mMidiOutputChannelSlider));
  mOscSendPortAttachment.reset(
      new juce::AudioProcessorValueTreeState::SliderAttachment(
          audioProcessor.getValueTreeState(), "oscSendPort",
          mOscSendPortSlider));
  mOscReceivePortAttachment.reset(
      new juce::AudioProcessorValueTreeState::SliderAttachment(
          audioProcessor.getValueTreeState(), "oscReceivePort",
          mOscReceivePortSlider));

  auto &vts = audioProcessor.getValueTreeState();
  mMidiCcSeqResetModeComboBox.addItemList(
      vts.getParameter("midiCcSeqResetMode")->getAllValueStrings(), 1);
  mMidiCcHardResetModeComboBox.addItemList(
      vts.getParameter("midiCcHardResetMode")->getAllValueStrings(), 1);
  mMidiCcSoftResetModeComboBox.addItemList(
      vts.getParameter("midiCcSoftResetMode")->getAllValueStrings(), 1);

  mMidiCcSeqResetAttachment.reset(
      new juce::AudioProcessorValueTreeState::SliderAttachment(
          vts, "midiCcSeqReset", mMidiCcSeqResetSlider));
  mMidiCcSeqResetModeAttachment.reset(
      new juce::AudioProcessorValueTreeState::ComboBoxAttachment(
          vts, "midiCcSeqResetMode", mMidiCcSeqResetModeComboBox));
  mMidiCcHardResetAttachment.reset(
      new juce::AudioProcessorValueTreeState::SliderAttachment(
          vts, "midiCcHardReset", mMidiCcHardResetSlider));
  mMidiCcHardResetModeAttachment.reset(
      new juce::AudioProcessorValueTreeState::ComboBoxAttachment(
          vts, "midiCcHardResetMode", mMidiCcHardResetModeComboBox));
  mMidiCcSoftResetAttachment.reset(
      new juce::AudioProcessorValueTreeState::SliderAttachment(
          vts, "midiCcSoftReset", mMidiCcSoftResetSlider));
  mMidiCcSoftResetModeAttachment.reset(
      new juce::AudioProcessorValueTreeState::ComboBoxAttachment(
          vts, "midiCcSoftResetMode", mMidiCcSoftResetModeComboBox));
...
void AmenBreakControllerAudioProcessorEditor::resized() {
  ...
  mSequencePositionSlider.setBounds(10, y + rowHeight - 15, getWidth() - 20,
                                    sliderHeight);
  y += sliderHeight + 10;
  mNoteSequencePositionLabel.setBounds(10, y, labelWidth, rowHeight);
  mNoteSequencePositionSlider.setBounds(10, y + rowHeight - 15, getWidth() - 20,
                                        sliderHeight);
  y += sliderHeight + 15;
  ...
  mMidiCcSeqResetModeComboBox.setBounds(10 + labelWidth + 105, y,
                                        controlWidth - 105, rowHeight);
  y += rowHeight + 5;

  mMidiCcHardResetLabel.setBounds(10, y, labelWidth, rowHeight);
  mMidiCcHardResetSlider.setBounds(10 + labelWidth, y, 100, rowHeight);
  mMidiCcHardResetModeComboBox.setBounds(10 + labelWidth + 105, y,
                                         controlWidth - 105, rowHeight);
  y += rowHeight + 5;

  mMidiCcSoftResetLabel.setBounds(10, y, labelWidth, rowHeight);
  mMidiCcSoftResetSlider.setBounds(10 + labelWidth, y, 100, rowHeight);
  mMidiCcSoftResetModeComboBox.setBounds(10 + labelWidth + 105, y,
                                         controlWidth - 105, rowHeight);
  y += rowHeight + 15;
  ...
  mHardResetButton.setBounds(140, y, 120, rowHeight);
  mSoftResetButton.setBounds(270, y, 120, rowHeight);
}

void AmenBreakControllerAudioProcessorEditor::buttonClicked(
    juce::Button *button) {
  if (button == &mSequenceResetButton) {
    audioProcessor.sendOscMessage(juce::OSCMessage("/sequenceReset"));
  } else if (button == &mHardResetButton) {
    audioProcessor.sendOscMessage(juce::OSCMessage("/hardReset"));
  } else if (button == &mSoftResetButton) {
    audioProcessor.sendOscMessage(juce::OSCMessage("/softReset"));
  }
}

void AmenBreakControllerAudioProcessorEditor::textEditorTextChanged(
